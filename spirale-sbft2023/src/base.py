...
class RoadtitionBase():
    ...
    def fitness_generator(self, heir_population, fitness_parent, oob):
        ...
        while fitness_parent >= 0 and v:
            ...
            if len(heir_population) > 4:
                new_population, new_fitness = self.fitness_of_one_population(heir_population, oob,
                                                                             5)  # mi estrapolo solo le 5 strade che hanno fitness più basse, se ci sono!
    ...
    def fitness_of_one_population(self, heir_population, oob, n):
        ...
        for i in range(0, n):  # estraggo n valori dalla popolazione
            ...
            new_population.append(heir_population[
                                      indice_minimo])  # in modo da accodare la strada alla nuova popolazione con solo gli oob minori
