...
from .operator import TestGenerationSampling, TestGenerationCrossover, TestGenerationMutation
from .problem import TestGenerationProblem
...
class Optimizer:
    ...
    def __init__(self, rng, segments_range, length_range, total_length_range, radius_range, map_size, termination=DEFAULT_TERMINATION, sampling=None):
