...
from src.generation.optimize import Optimizer, get_termination, POP_SIZE
from src.road import Road, segments_distance
...
class RoadSignGenerator():
    ...
    def __init__(self, executor, map_size=200, segments_range=(10, 30), length_range=None, total_length_range=None,
                 radius_range=(30, 100), gen_max_time=60, seed_samples=10, gen_samples=10):
